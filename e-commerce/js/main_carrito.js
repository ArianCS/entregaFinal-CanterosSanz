const renderProductosCarrito = () => {
    ...
    if (totalCarrito() > 0) {    
        ...
        <tbody>
        <tr>
        <td colspan="6" class="text-end"><a href="#" class="btn btn-success" onClick="vaciarCarrito()">Vaciar Carrito <img src="images/trash3.svg" alt="Vaciar Carrito" width="16" /></a></td>
        </tr>`;
        ...
        for (let producto of productos_carrito) {
            ...
            <td class="align-middle"><button class="btn btn-success rounded-circle" title="Eliminar Item" onClick="eliminarItemProducto(${producto.id});"> - </button> ${producto.cantidad} <button class="btn btn-success rounded-circle" title="Agregar Item" onClick="agregarItemProducto(${producto.id});"> + </button></td>
        ...
        salida = `<div class="alert alert-success text-center" role="alert">Aun no veo productos que cargar.</div>`;
    }
